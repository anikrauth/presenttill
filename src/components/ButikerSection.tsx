    ...
    return(
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-[40px] lg:py-[60px] px-5 md:px-[40px] lg:px-[60px] xl:px-[150px]">
                {
                    data?.butik?.butikerfields?.kampanjerLink && data?.butik?.butikerfields?.presenttipsLink ? (
                        <>
                            <div className="shadow p-5 text-primary_color text-center">
                                ...
                                <h3 className="text-[22px] md:text-[32px] font-medium pb-[20px]">Butikens egna <span
                                    className="text-secondary_color font-semibold ">presenttips</span></h3>
                                <p className="text-[17px] font-normal pb-[30px]">
                                    {data?.butik?.butikerfields?.presenttipsDescription}
                                </p>
                                ...
                                <Link
                                    ...
                                    <span
                                        className="pr-2">{data?.butik?.butikerfields?.presenttipsButtonLabel ? data?.butik?.butikerfields?.presenttipsButtonLabel : `Besök ${data?.butik?.title}`}</span>
                            ...
                            <div className="shadow p-5 text-primary_color text-center">
                                ...
                                <h3 className="text-[22px] md:text-[32px]  font-medium pb-[20px]">Butikens <span
                                    className="text-secondary_color font-semibold ">kampanjer</span></h3>
                                ...
                                <Link
                                    ...
                                    <span
                                        className="pr-2">{data?.butik?.butikerfields?.kampanjerButtonLabel ? data?.butik?.butikerfields?.kampanjerButtonLabel : `Besök ${data?.butik?.title}`}</span>
                                    <span><FiArrowUpRight className="w-6 h-6"/></span>
                                </Link>
